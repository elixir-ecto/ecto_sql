defmodule Ecto.Adapters.SQL do
  ...
  When `generic_plan` is set to `true`, an explain plan for the generic query
  generated by Postgres is generated and the supplied query parameters are ignored.
  See `plan_cache_mode` in the [Postgres docs](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-PLAN-CACHE-MODE)
