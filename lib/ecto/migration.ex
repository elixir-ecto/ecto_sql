defmodule Ecto.Migration do
  ...
  ## Options
    ...
    * `:default` - the column's default value. It can be a string, number, empty
      ...
      `fragment/1`.
    * `:null` - determines whether the column accepts null values. The default value
      for this option equals to the default of the database your adapter connects (for
      example, PostgreSQL 14 defaults to `true` when not specified).
  ...
  ## Options
    ...
    * `:null` - determines whether the column accepts null values. The default value
      for this option equals to the default of the database your adapter connects (for
      example, MySQL 8 defaults to `true` when not specified).
